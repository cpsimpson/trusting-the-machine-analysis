...
s2_anthro_author_content_model <- '
  # direct effect
...
# Fit the model
s2_anthro_author_content_model_fit <- sem(s2_anthro_author_content_model, data = s2_cleaned_data, se = "bootstrap", bootstrap = 5000)

# Summary with standardized estimates
summary(s2_anthro_author_content_model_fit, standardized = TRUE, ci = TRUE)
...
plot_lavaan_model(s2_anthro_author_content_model_fit, labels, "anthro_author_content", s2_study)
...
# Define mediation model
s2_anthro_content_author_model <- '
  # direct effect
...
# Fit the model
s2_anthro_content_author_model_fit <- sem(s2_anthro_content_author_model, data = s2_cleaned_data, se = "bootstrap", bootstrap = 5000)

# Summary with standardized estimates
summary(s2_anthro_content_author_model_fit, standardized = TRUE, ci = TRUE)
...
plot_lavaan_model(s2_anthro_content_author_model_fit, labels, "anthro_content_author", s2_study)
...
s2_pct <- s2_cleaned_data |> partial_correlation_test("anthropomorphism_score", "author_trust_combined_score", "content_trust_combined_score")


s2_boot <- s2_cleaned_data |> bootstrap_correlation_comparison("anthropomorphism_score", "author_trust_combined_score", "content_trust_combined_score")
```
...
s2_cleaned_data |> partial_correlation_test("content_trust_combined_score", "author_trust_combined_score", "anthropomorphism_score")
...
plot_corr_vs_partial_bars(
  s2_cleaned_data,
  study = s2_study, 
  name = "freq_content_author",
  x = "AIChatbotsFrequency_n",
  y = "author_trust_combined_score",
  z = "content_trust_combined_score",
  x_label = "freq",
  y_label = "author",
...
plot_corr_vs_partial_bars(
  s2_cleaned_data,
  study = s2_study, 
  name = "intention_content_author",
  x = "intention_to_use_score",
  y = "author_trust_combined_score",
  z = "content_trust_combined_score",
  x_label = "intention",
  y_label = "author",
...
plot_corr_vs_partial_bars(
  s2_cleaned_data,
  study = s2_study, 
  name = "number_content_author",
  x = "number_ai_chatbots_used",
  y = "author_trust_combined_score",
  z = "content_trust_combined_score",
  x_label = "number",
  y_label = "author",
...
plot_corr_vs_partial_bars(
  ...
  study = s2_study, 
  name = "anthro_content_author",
  z = "anthropomorphism_score",
  y = "author_trust_combined_score",
  x = "content_trust_combined_score",
  z_label = "Anthro",
  y_label = "Author",
  x_label = "Content"
)
