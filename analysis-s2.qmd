...
# s2_cleaned_data$Appelman_6 <- as.numeric(s2_cleaned_data$Appelman_6)
# s2_cleaned_data |> test_correlation("anthropomorphism_score", "Appelman_6")
# 
...
s2_cleaned_data$AIChatbotsFrequency_ordinal <- as.numeric(factor(s2_cleaned_data$AIChatbotsFrequency_regrouped,
  ...
  s2_cleaned_data$Appelman_4_n <- as.numeric(as.character(s2_cleaned_data$Appelman_4))
  s2_cleaned_data$Appelman_5_n <- as.numeric(as.character(s2_cleaned_data$Appelman_5))
  s2_cleaned_data$Appelman_6_n <- as.numeric(as.character(s2_cleaned_data$Appelman_6))
```
...
model_design <- '
  ...
  likeability_score ~ fear_of_ai_score + AIChatbotsFrequency_ordinal + Appelman_4_n + Appelman_5_n + Appelman_6_n
  competence_score ~ fear_of_ai_score + AIChatbotsFrequency_ordinal + Appelman_4_n + Appelman_5_n + Appelman_6_n
  anthropomorphism_score ~ AIChatbotsFrequency_ordinal + Appelman_4_n + Appelman_5_n + Appelman_6_n
  author_trust_combined_score ~ fear_of_ai_score + intention_to_use_score + AIChatbotsFrequency_ordinal + professional_content_expertise + Appelman_4_n + Appelman_5_n + Appelman_6_n
  content_trust_combined_score ~ fear_of_ai_score + intention_to_use_score + AIChatbotsFrequency_ordinal + professional_content_expertise + Appelman_4_n + Appelman_5_n + Appelman_6_n
