...
basic_descriptives(s2_cleaned_data$writing_quality)
...
# result
# 
# result <- s2_cleaned_data |> test_correlation(professional_content_expertise, content_trust_combined_score)
# result
...
# result
# 
# result <- s2_cleaned_data |> test_correlation(professional_content_expertise, author_trust_combined_score)
# result
...
model_design <- '
  ...
  likeability_score ~ c1*Condition
  competence_score ~ c1*Condition
  
  # # Latent Constructs 
  # perceptions_of_author
  # attitudes_towards_ai
  # content_experience
  # writing_quality
  # 
  # 
  # author_trust_combined_score ~ d1*Condition + d2*anthropomorphism_score + d3*likeability_score + d4*competence_score + fear_of_ai_score + intention_to_use_score + AIChatbotsFrequency_ordinal 
  # content_trust_combined_score ~ e1*author_trust_combined_score + e2*ScienceContent_ordinal + WellWritten_n + Boring_n + Engaging_n + professional_content_expertise
  # 
  # # Covariances
  # likeability_score ~~ competence_score
  # anthropomorphism_score ~~ likeability_score
  # anthropomorphism_score ~~ competence_score
  # 
  # # Additional predictors
  # likeability_score ~ fear_of_ai_score + AIChatbotsFrequency_ordinal + WellWritten_n + Boring_n + Engaging_n + anthropomorphism_score + Condition
  # competence_score ~ fear_of_ai_score + AIChatbotsFrequency_ordinal + WellWritten_n + Boring_n + Engaging_n + Condition + likeability_score + anthropomorphism_score
  # anthropomorphism_score ~ AIChatbotsFrequency_ordinal + Condition
