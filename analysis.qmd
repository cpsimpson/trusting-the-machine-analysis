...
```{r}
# run_variance_analysis(data = cleaned_data, formula = content_trust_combined_score ~ AIChatbotsFrequency_regrouped, x = cleaned_data$AIChatbotsFrequency_regrouped, y = cleaned_data$content_trust_combined_score)
