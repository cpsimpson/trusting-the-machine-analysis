...
-   How much violation of assumptions for ANOVA is too much?
    ...
    -   I could use some help interpreting some of the linear model data for interactions. For example, see Age under Content Trust analysis. There are a few pairings that have significant p-values, but I'm having trouble seeing if it means anything. Which kind of makes me think it isn't that meaningful :)
...
-   There is an Experience question that I haven't looked at at all yet
